...

{
    ...
    {
        // Gracias al Singleton en DecisionManager, este acceso ahora es seguro.
        if (DecisionManager.Instance == null)
        {
            Debug.LogError("DecisionManager no encontrado. Usando opción 1 por defecto. Asegúrate de que el GameObject con el DecisionManager esté activo en la escena.");
            playerChoice = 1;
            yield break;
        }
